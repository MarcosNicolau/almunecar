...
int main() {
    BEGIN_BENCHMARK()
    benchmark(benchmark_random_prime, 1, 4);
    benchmark(benchmark_random_prime, 1, 8);
    benchmark(benchmark_random_prime, 1, 16);
    benchmark(benchmark_is_prime_solovay_strassen, 1, 8,
    ...
    benchmark(benchmark_is_prime_solovay_strassen, 1, 16,
