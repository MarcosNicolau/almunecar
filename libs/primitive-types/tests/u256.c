...
void test_u256_overflow_add() {
    u256 first = {{18446744073709551615ULL, 18446744073709551615ULL,
                   1099511627775ULL, 0}};
    u256 second = {{18446744073709551615ULL, 18446744073709551615ULL,
                    1099511627775ULL, 0}};
    u256_overflow_op result = u256_overflow_add(first, second);
    u256 expected_result = {{18446744073709551614ULL, 18446744073709551615ULL,
                             2199023255551ULL, 0}};
...
void test_u256_overflow_sub() {
    u256 first = {{18446744073709551615ULL, 18446744073709551615ULL,
                   1099511627775ULL, 0}};
    u256 second = {
        {2919980651337220095ULL, 14019525496019259228ULL, 10995116277ULL, 0}};
    u256_overflow_op result = u256_overflow_sub(first, second);
    u256 expected_result = {
        {15526763422372331520ULL, 4427218577690292387ULL, 1088516511498ULL, 0}};
...
void test_u256_overflow_sub_with_overflow() {
    ...
    u256_overflow_op result = u256_overflow_sub(first, second);
    u256 expected_result = {
        {UINT64_MAX, UINT64_MAX - 1, UINT64_MAX - 1, UINT64_MAX - 1}};
...
void test_u256_overflow_mul() {
    ...
    u256 expected_result = {
        {15526763422372331521ULL, 2919980651337220094ULL, 0, 0}};
...
void test_u256_overflow_mul_with_overflow() {
    ...
    u256 second = {
        {2919980651337220095ULL, 14019525496019259228ULL, 10995116277ULL, 0}};
    u256_overflow_op result = u256_overflow_mul(first, second);
    u256 expected_result = {{15526763422372331521ULL, 4427218577690292387ULL,
                             17870282210899384074ULL, 14019525494141808257ULL}};
...
void test_u256_bitor() {
    u256 first = {{18446744073709551615ULL, 18446744073709551615ULL,
                   1099511627775ULL, 0}};
    u256 second = {{2919980651337220095ULL, 14019525496019259228ULL,
                    10995116277ULL, 1ULL}};
...
void test_u256_bitxor() {
    u256 first = {{18446744073709551615ULL, 18446744073709551615ULL,
                   1099511627775ULL, 1}};
    u256 second = {
        {2919980651337220095ULL, 14019525496019259228ULL, 10995116277ULL, 1}};
...
void test_u256_bitnot() {
    ...
    u256 expected_result = {
        {0, 0, 18446742974197923840ULL, 18446744073709551615ULL}};
...
void test_u256_shl() {
    ...
    u256 expected_result = {
        {0, 0, 18446744073709551612ULL, 18446744073709551615ULL}};
...
void test_u256_divmod_without_rem() {
    ...
    u256_div_op result = u256_divmod(first, second);
    u256 expected_quot = {
        {6148914691236517205ULL, 6148914691236517205ULL, 366503875925ULL, 0}};
...
void test_u256_to_string() {
    char *result =
        u256_to_string((u256){{18446744073709551615ULL, 18446744073709551615ULL,
                               1099511627775ULL, 0}});
...
void test_u256_get_bytes_little_endian() {
    ...
    uint8_t expected_result[32] = {255, 255, 255, 255, 255, 255, 255, 255,
